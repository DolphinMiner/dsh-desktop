...
const bridge: DesktopBridge = {
  ...
  browser: {
    ...
    find: input => ipcRenderer.invoke('desktop:browser:find', input),
    zoom: input => ipcRenderer.invoke('desktop:browser:zoom', input),
    print: () => ipcRenderer.invoke('desktop:browser:print'),
    saveScreenshot: () => ipcRenderer.invoke('desktop:browser:save-screenshot'),
