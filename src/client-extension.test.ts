...
test('packages desktop settings and navigation through the official Harness loader', async () => {
  ...
  assert.match(bundle, /installDirectory/)
  assert.match(bundle, /installRegistry/)
  assert.match(bundle, /npm package/)
  ...
  assert.match(bundle, /id: "desktop-titlebar"/)
  assert.match(bundle, /name: "shell\.overlay"/)
  assert.match(bundle, /Right sidebar tools/)
  assert.doesNotMatch(bundle, /name: "details",\s*priority: -10/)
  assert.doesNotMatch(bundle, /name: "conversation\.view",\s*id: "browser"/)
  ...
  assert.doesNotMatch(bundle, /Capture now/)
  ...
  assert.doesNotMatch(bundle, /Activity and emergency stop/)
  assert.doesNotMatch(bundle, /Recent computer actions/)
  ...
  assert.match(bundle, /resizeViewport/)
